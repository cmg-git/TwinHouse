...
alphaOut = 0.23;        % SW absortivity wall out
alphaIn = 0.17;         % SW absortivity wall in
tau = 0.427;            % SW windows transmittance
                        % transmission coefficient function azimuth & time
...
Qr1 = alphaIn*Aw*tauW.*Qw + 0.3*Q1; % kit: West window + k-heater
Qr2 = 0.3*Q2;                       % doorw
Qr3 = alphaIn*Aw*tauN.*Qn + 0.3*Q3; % 1bed
Qr4 = alphaIn*Aw*tauW.*Qw + 0.3*Q4; % liv: West window
Qr5 = 0.3*Q5;                       % cor
Qr6 = alphaIn*Aw*tauE.*Qe + 0.3*Q6; % bath    
Qr7 = alphaIn*Aw*tauS.*Qs + 0.3*Q7; % 2bed

%% Surfaces & volumes of rooms
S1 = 2*(2.495*(2.83 + 2.62) + 2.83*2.62);   % kit
V1 = 2.495*2.83*2.62;
S2 = 2*(2.495*(2.22 + 2.62) + 2.22*2.62);   % doorw
V2 = 2.495*2.22*2.62;
S3 = 2*(2.495*(3.88 + 2.88) + 3.88*2.88);   % 1bed
V3 = 2.495*3.88*2.88;
S4 = 2*(2.495*(5.20 + 6.46) + 5.20*6.46);   % liv
V4 = 2.495*5.20*6.46;
S5 = 2*(2.495*(1.65 + 3.29) + 1.65*3.29);   % corr
V5 = 2.495*1.65*3.29;
S6 = 2*(2.495*(2.08 + 3.29) + 2.08*3.29);   % bath
V6 = 2.495*2.08*3.29;   
S7 = 2*(2.495*(3.88 + 2.88) + 3.88*2.88);  % 2bed
V7 = 2.495*3.88*2.88;
...
TCd{t0+5} = AirZ(0, V5, ACH50, Koff, [To'; T5'], 0.7*Q5');          % c
TCd{t0+6} = AirZ(0, V6, ACH50, Koff, [To'; T6'], 0.7*Q6');          % b
TCd{t0+7} = AirZPillar(1, V7, ACH50, Koff, [To'; T7'], 0.7*Q7');    % 2b
nt0 = 7;
...
nt(2) = 6;  % no objects of this type
